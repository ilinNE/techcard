...
def semifabricate(user, product_1, product_2):
    ...
    semifabricate.ingredients.add(
        product_1,
        through_defaults={"amount": 0.024, "cold_waste": 0, "hot_waste": 0},
    )
    semifabricate.ingredients.add(
        product_2,
        through_defaults={"amount": 1, "cold_waste": 50, "hot_waste": 0},
    )
...
def techcard(user, product_1, product_2):
    techcard = TechCard.objects.create(
        owner=user, name="Testcard", description="text", weight=0
    )
