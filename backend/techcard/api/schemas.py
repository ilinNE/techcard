...
from .serializers import (ProductSerializer, SendMailSerializer, TagSerializer,
                          TechCardSerializer,
...
NOT_FOUND_RESPONSE = OpenApiResponse(
    OpenApiTypes.STR, examples=[examples.NOT_FOUND_EXAMPLE]
)
NOT_ALLOWED_RESPONSE = OpenApiResponse(
    OpenApiTypes.STR, examples=[examples.METHOD_NOT_ALLOWED_EXAMPLE]
)
