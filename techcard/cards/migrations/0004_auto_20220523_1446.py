...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='techcard',
            name='semifabricate',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cards.product'),
        ),
        migrations.AlterField(
            model_name='product',
            name='unit',
            field=models.CharField(choices=[('Шт', 'Шт'), ('Кг', 'Кг'), ('Л', 'Л')], default='Кг', max_length=2),
        ),
        migrations.AlterField(
            model_name='techcard',
            name='create_date',
